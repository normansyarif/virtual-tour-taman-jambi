<div class="topnav">
	...
	<ul>
		<li><a class="mobile-brand m-head" href="{{ route('home') }}">Sistem Informasi<br />Ruang Terbuka Hijau</a></li>

		@if (Auth::guest())
		<li><a style="font-size: 1em" href="#">Kontak</a></li>
		<li><a style="font-size: 1em" href="#">Login</a></li>

		@else
		<li><a style="font-size: 1em" href="#">Dashboard</a></li>
